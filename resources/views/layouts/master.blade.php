...
<div class="bg-white">
    {{-- Header Section --}}
    <header class="bg-gray-300 absolute inset-x-0 top-0 z-50">
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                ...
                <a href="#" class="text-sm/6 font-semibold text-gray-900">Books</a>
                <a href="#" class="text-sm/6 font-semibold text-gray-900">Rental</a>
                {{--                    <a href="#" class="text-sm/6 font-semibold text-gray-900"></a>--}}
            </div>
